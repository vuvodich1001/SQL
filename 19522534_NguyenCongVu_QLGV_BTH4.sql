...
BEGIN
	...
	SELECT @TRUONGLOP = TRLOP FROM INSERTED
	SELECT @MALOP_HV = MALOP FROM HOCVIEN WHERE MAHV = @TRUONGLOP
	SELECT @MALOP_LOP = MALOP FROM LOP WHERE TRLOP = @TRUONGLOP
...
BEGIN
	...
	SELECT @TRKHOA = TRKH FROM INSERTED
	SELECT @MAKH_KHOA = MAKH FROM KHOA WHERE TRKH = @TRKHOA
	SELECT @MAKH_GIAOVIEN = MAKH FROM GIAOVIEN WHERE MAGV = @TRKHOA
	SELECT @HOCVI = HOCVI FROM GIAOVIEN WHERE MAGV = @TRKHOA
...
-- CAU 23
SELECT * FROM GIANGDAY ORDER BY MALOP, NAM, HOCKY ASC
